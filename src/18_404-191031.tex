	...
	\begin{definition*}
		...
		\[
			\begin{array}{| c | c | c | c | c | c | c | c |} \hline
				q_0 & w_1 & w_2 & \!\dots\! & w_n & \blank & \blank & \blank \\ \hline
				  &   &   &   &   &   &   &   \\ \hline
				  &   &   &   &   &   &   &   \\ \hline
				  &   &   &   &   &   &   &   \\ \hline
				  &   &   &   &   &   &   &   \\ \hline
...
\begin{proof}
	...
	In our graph, we will also have a node for each possible literal, i.e. two nodes for each variable. We can force all of these to have opposite colorings using the same method we did for \textsc{true} and \textsc{false}.
	\begin{center}
		\begin{tikzpicture}[
			every node/.style={circle, draw, inner sep=2pt},
			bnode/.style={blue, fill={cyan!10!white}},
