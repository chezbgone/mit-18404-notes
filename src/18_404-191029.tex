...
\begin{problem}[SAT]
  ...
  \(\land\)s, \(\lor\)s, and \(\neg\)s.
  We want to determine whether there exists some assignment of variables over \(\set{\textsc{true}, \textsc{false}}\) or \(\set{1, 0}\) that makes the formula true. We call this problem \textit{SAT}. More formally,
	\[
